...
module PgRls
  # The ConnectionConfig module provides methods to configure and manage
  ...
  module ConnectionConfig
    class << self
      def look_up_connection_config
        ...
        config_hash = build_config_hash(default_connection_db_config, default_connection_name)
